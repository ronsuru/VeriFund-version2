...
import { useQuery } from "@tanstack/react-query";export default function LoginPage() {
...
// If already authenticated, redirect appropriately
  ...
  useEffect(() => {
    if (user) {
      const isAdmin = (user as any)?.isAdmin === true || (user as any)?.isSupport === true;
      window.location.href = isAdmin ? "/admin" : "/";
    }
  }, [user]);  // OAuth sign in functions
...
// After successful login, decide redirect based on server user role
          try {
